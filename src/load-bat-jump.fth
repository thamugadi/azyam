...
: compile-load-bat-jump-to-entry
  ['] load-bat-jump-to-entry here - allot \ moves the dictionary pointer at the beginning of load-bat-jump-to-entry
  \ now what's going to be specified with ',' is located there
  ...
  here ['] load-bat-jump-to-entry - allot \ move the dictionary pointer back to its original value
;
